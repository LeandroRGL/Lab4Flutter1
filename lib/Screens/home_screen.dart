...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    const List peliculasyTVseries = [
      {'url': 'assets/img_peliculas/Avatar.jpg', 'name': 'Avatar: El camino del agua', 'duration': 'Duracion: 2h 39m'},
      {
        'url': 'assets/img_peliculas/Five Nights.jpg',
        'name': 'Five Nights at Freddy: La pelicula',
        'duration': 'Duracion: 1h 50m'
      },
      {'url': 'assets/img_peliculas/Flash.jpg', 'name': 'Flash', 'duration': 'Duracion: 1h 30m'},
      {'url': 'assets/img_peliculas/Leo.jpg', 'name': 'Leo', 'duration': 'Duracion: 1h 42m'},
      {'url': 'assets/img_peliculas/Saw.jpg', 'name': 'Saw X', 'duration': 'Duracion: 1h'},
      {'url': 'assets/img_peliculas/Spiderman.jpg', 'name': 'Spiderman: No way home', 'duration': 'Duracion: 1h 30m'},
      {'url': 'assets/img_peliculas/Wonka.jpg', 'name': 'Wonka', 'duration': 'Duracion: 1h 57m'},
      {'url': 'assets/img_seriestv/Black Mirror.jpg', 'name': 'Black Mirror', 'duration': 'Duracion: 30 episodios'},
      {'url': 'assets/img_seriestv/Narcos.jpg', 'name': 'Narcos', 'duration': 'Duracion: 45 episodios'},
      {'url': 'assets/img_seriestv/Peaky Blinders.jpg', 'name': 'Peaky Blinders', 'duration': 'Duracion: 50 episodios'},
      {'url': 'assets/img_seriestv/Sherlock.jpg', 'name': 'Sherlock', 'duration': 'Duracion: 27 episodios'},
      {
        'url': 'assets/img_seriestv/Stranger Things.jpg',
        'name': 'Stranger Things',
        'duration': 'Duracion: 45 episodios'
      },
      {'url': 'assets/img_seriestv/Breaking Bad.jpg', 'name': 'Breaking Bad', 'duration': 'Duracion: 65 episodios'},
      {'url': 'assets/img_seriestv/Ozark.jpg', 'name': 'Ozark', 'duration': 'Duracion: 52 episodios'}
    ];
    const List actores = [
      {
        'url': 'assets/img_actores/Ana de Armas.jpg',
        'name': 'Ana de Armas',
        'duration':
      ...
      {
        'url': 'assets/img_actores/Aya Asahina.jpg',
        'name': 'Aya Asahina',
        'duration':
      ...
      {
        'url': 'assets/img_actores/Farrah Mackenzie.jpg',
      ...
      {
        'url': 'assets/img_actores/Ian Mc Shane.jpg',
        'name': 'Ian Mc Shane',
        'duration':
      ...
      {
        'url': 'assets/img_actores/Josh hutcherson.jpg',
      ...
      {
        'url': 'assets/img_actores/Nicolas Cage.jpg',
        'name': 'Nicolas Cage',
        'duration':
      ...
      {
        'url': 'assets/img_actores/Song Kang.jpg',
        'name': 'Song Kang',
        'duration':
      ...
      {
        'url': 'assets/img_actores/Tom Hanks.jpg',
        'name': 'Tom Hanks',
        'duration':
      ...
      {
        'url': 'assets/img_actores/Sydney Sweeney.jpg',
        'name': 'Sydney Sweeney',
        'duration':
      ...
      {
        'url': 'assets/img_actores/Jeremy Piven.jpg',
        'name': 'Jeremy Piven',
        'duration':
    ...
    return Scaffold(
      backgroundColor: Color.fromRGBO(1, 20, 32, 1),
      appBar: AppBar(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          CardSwiper(
            text: "Peliculas y Series destacadas",
