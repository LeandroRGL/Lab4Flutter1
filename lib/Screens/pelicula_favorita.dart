  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          CardImage(
            url: 'assets/img_peliculas/Flash.jpg',
            text: "Flash",
            subtext:
          ...
          CardImage(
            url: 'assets/img_peliculas/Krampus.jpg',
            text: 'Krampus',
            subtext:
          ...
          CardImage(
            url: 'assets/img_peliculas/Mario.jpg',
            text: "Mario",
            subtext:
          ...
          CardImage(
            url: 'assets/img_peliculas/Saw.jpg',
          ...
          CardImage(
            url: 'assets/img_peliculas/Spiderman.jpg',
            text: "Spiderman: Sin camino a casa",
            subtext:
                "Peter Parker es desenmascarado y ya no puede separar su vida normal de los altos riesgos de ser un súper héroe. Cuando pide ayuda al Doctor Strange para recuperar su secreto, el hechizo crea un agujero en su mundo, liberando a los villanos más poderosos que han luchado con cualquier Spider-Man, en cualquier universo. Ahora Peter debe de superar su reto más grande, que no solo alterara su propio futuro pero el del multiverso, forzándolo a descubrir lo que realmente significa ser Spider-Man.",
          ),
          CardImage(
            url: 'assets/img_peliculas/The marvels.jpg',
            text: "The Marvels",
            subtext:
          ...
          CardImage(
            url: 'assets/img_peliculas/Oppenheimer.jpg',
            text: "Oppenheimer",
            subtext:
          ...
          CardImage(
            url: 'assets/img_peliculas/Wish.jpg',
          ...
          CardImage(
            url: 'assets/img_peliculas/Wonka.jpg',
            text: "Wonka",
            subtext:
          ...
          CardImage(
            url: 'assets/img_peliculas/Spiderman across.jpg',
